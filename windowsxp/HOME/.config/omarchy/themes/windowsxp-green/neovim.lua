return {
  {
    ...
    opts = {
      ...
      on_highlights = function(hl, c)
        ...
        hl.StatusLine = { bg = "#0AB80A", fg = "#FFFFFF" }
        hl.StatusLineNC = { bg = "#006600", fg = "#7DFF7D" }
        hl.TabLine = { bg = "#006600", fg = "#7DFF7D" }
        hl.TabLineSel = { bg = "#FFFF60", fg = "#000000" }
        hl.MatchParen = { fg = "#FFFF60", bold = true }
        hl.CursorLine = { bg = "#0AB80A" }
        hl.Pmenu = { bg = "#006600", fg = "#FFFFFF" }
        ...
        hl.Directory = { fg = "#7DFF7D", bold = true }
        hl.Question = { fg = "#60FF60", bold = true }
        hl.MoreMsg = { fg = "#60FF60", bold = true }
        hl.WarningMsg = { fg = "#FFFF60", bold = true }
        hl.SpecialKey = { fg = "#7DFF7D" }
        hl.NonText = { fg = "#7DFF7D" }
        hl.Whitespace = { fg = "#7DFF7D" }
        hl.VertSplit = { fg = "#7DFF7D" }
        hl.Folded = { fg = "#7DFF7D", bg = "#006600" }
        hl.FoldColumn = { fg = "#7DFF7D", bg = "#009800" }
        hl.SignColumn = { bg = "#009800", fg = "#7DFF7D" }
        hl.Conceal = { fg = "#7DFF7D" }
        hl.DiffAdd = { fg = "#60FF60" }
        hl.DiffChange = { fg = "#FFFF60" }
        hl.DiffDelete = { fg = "#FF6B6B" }
        hl.DiffText = { fg = "#7DFF7D" }
